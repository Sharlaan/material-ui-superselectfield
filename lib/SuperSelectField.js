...
const _reactInfinite = require('react-infinite')

const _reactInfinite2 = _interopRequireDefault(_reactInfinite)

const _ListItem = require('material-ui/List/ListItem')
...
const _TextField = require('material-ui/TextField/TextField')

const _TextField2 = _interopRequireDefault(_TextField)

const _SelectionsPresenter = require('./SelectionsPresenter')

const _SelectionsPresenter2 = _interopRequireDefault(_SelectionsPresenter)
...
const SelectField = (function (_Component) {
  ...
  function SelectField (props, context) {
    ...
    _this.handleMenuSelection = function (selectedItem) {
      return function (event) {
        ...
        if (_this.props.multiple) {
          ...
          const updatedValue = (0, _utils.areEqual)(selectedItems, selectedItem) ? null : selectedItem
    ...
    const itemsLength = (0, _utils.getChildrenLength)(children)
    _this.state = {
      isOpen: false,
      isFocused: false,
  ...
  SelectField.prototype.componentWillReceiveProps = function componentWillReceiveProps (nextProps) {
    ...
    if (!(0, _utils.areEqual)(nextProps.children, this.props.children)) {
      const itemsLength = (0, _utils.getChildrenLength)(nextProps.children)
      this.setState({
        itemsLength: itemsLength,
  ...
  SelectField.prototype.render = function render () {
    ...
    const menuItems =
      ...
      fixedChildren.reduce(function (nodes, child, index) {
        ...
        const menuGroup = _react2.default.createElement(_ListItem2.default, {
          disabled: true,
          key: nextIndex,
      ...
      _react2.default.createElement(
        ...
        multiple &&
          _react2.default.createElement(
            ...
            _react2.default.createElement('div', { onClick: this.closeMenu, style: menuFooterStyle }, menuCloseButton)
          )
      )
    )
  }
...
SelectField.contextTypes = {
  muiTheme: _propTypes.object.isRequired,
}
SelectField.propTypes = process.env.NODE_ENV !== 'production' ? _types.selectFieldTypes : {}
SelectField.defaultProps = _defaultProps.selectFieldDefaultProps
