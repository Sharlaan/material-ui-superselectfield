...
var SelectionsPresenter = function SelectionsPresenter(_ref5) {
  var selectedValues = _ref5.selectedValues,
      ...
      alwaysDisplaySelectionsRenderer = _ref5.alwaysDisplaySelectionsRenderer;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      (alwaysDisplaySelectionsRenderer || shrinkCondition || !floatingLabel) && selectionsRenderer(selectedValues, hintText)
    ),
...
SelectionsPresenter.propTypes = {
  ...
  alwaysDisplaySelectionsRenderer: _react.PropTypes.bool
};
...
MenuFooter.propTypes = {
  closeHandler: _react.PropTypes.func
};
  ...
  _createClass(SelectField, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          alwaysDisplaySelectionsRenderer = _props2.alwaysDisplaySelectionsRenderer,
  ...
  this.closeMenu = function (reason) {
    ...
    if (allowSelectAll) {
      ...
      if (selectAllItemIndex !== -1) {
        selectedItems = [].concat(_toConsumableArray(selectedItems.slice(0, selectAllItemIndex)), _toConsumableArray(selectedItems.slice(selectAllItemIndex + 1)));
      }
    }
...
SelectField.propTypes = {
  ...
  autoCompleteElementHeight: _react.PropTypes.number,
  hintText: _react.PropTypes.string,
  ...
  selectionsRenderer: _react.PropTypes.func,
  footerRenderer: _react.PropTypes.oneOfType([_react.PropTypes.element, _react.PropTypes.arrayOf(_react.PropTypes.element)]),
  footerElementHeight: _react.PropTypes.number,
  multiple: _react.PropTypes.bool,
  disabled: _react.PropTypes.bool,
  onChange: _react.PropTypes.func,
  onAutoCompleteTyping: _react.PropTypes.func,
  selectAllItem: _react.PropTypes.object,
  allowSelectAll: _react.PropTypes.bool,
  selectAllRenderer: _react.PropTypes.func,
  selectAllElementHeight: _react.PropTypes.number,
  alwaysDisplaySelectionsRenderer: _react.PropTypes.bool,
  noMatchFoundHeight: _react.PropTypes.number
};
