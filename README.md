...
| children | any | null | Datasource is an array of any type of nodes, styled at your convenience.   
/!\ IMPORTANT: each node must expose at least a `value` property (required). This value property will be used by default for both option's value and label.
